...
$form = ActiveForm::begin([
  ...
  <div class="input-group input-group-lg">
    ...
    <div id="examtypearr">
        <?php foreach ($examTypeArr as $examTypeVal) { ?>
                   <span><?php echo $examTypeVal ?><a href='#' class='remove_field'> x</a><input type='hidden' name='ExamForm[exam_type][]' value='<?php echo $examTypeVal ?>'></span>            
         <?php } ?>
...
<?php echo $form->field($model, 'exam_section')->end(); ?>
    ...
    <div id="examsecarr">
        <?php foreach ($examSecArr as $examSecVal) { ?>
                   <span><?php echo $examSecVal ?><a href='#' class='remove_field'> x</a><input type='hidden' name='ExamForm[exam_section][]' value='<?php echo $examSecVal ?>'></span>            
         <?php } ?>
    </div>
  <div class="form-group"> 
<?php
